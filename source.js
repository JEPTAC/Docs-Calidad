...
function stepImageOnlyHtml(s){
  ...
  return `<div class="step-image-only">
    ...
    <div class="step-main-img ${hasImg?'':'empty-print'}">${hasImg?`<img src="${s.stepImage}" style="width:${w}%;height:${h}%;left:${x}%;top:${y}%">`:'<span class="empty-img no-print">Imagen del paso</span>'}</div>
  </div>`;
}
